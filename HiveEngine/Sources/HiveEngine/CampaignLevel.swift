...
public struct CampaignLevel: Sendable, Equatable, Identifiable, Codable {
    ...
    public static let allLevels: [CampaignLevel] = [
        CampaignLevel(
            ...
            tip: "O Guepardo pode percorrer todo o contorno livremente. Deslize-o até uma das casas vazias ao redor do Leão preto.",
        ...
        CampaignLevel(
            ...
            tip: "A Zebra precisa dar exatamente 3 passos ao longo da borda: 1, 2, 3 até a casa destacada.",
            botDifficulty: .didactic,
            botDifficultyName: "Didático",
            targetParTurns: 1,
            isPuzzleScenario: true,
