...
public struct CampaignLevel: Sendable, Equatable, Identifiable, Codable {
    ...
    public static let allLevels: [CampaignLevel] = [
        CampaignLevel(
            id: 1,
            chapterNumber: 1,
            title: "O Cerco do Guepardo",
            subtitle: "Deslize pelo Perímetro",
            narrative: "O Leão adversário já está encurralado em 4 dos seus 6 lados. Comande seus Guepardos velozes para deslizar pelo perímetro e fechar os 2 espaços restantes!",
            tip: "O Guepardo pode percorrer todo o contorno livremente. Lembre-se: peças que sustentam a colmeia ficam presas pela Regra da Colmeia Unida, mas as peças livres nas pontas têm caminho aberto!",
        ...
        CampaignLevel(
            id: 2,
            chapterNumber: 2,
            title: "A Rota da Zebra",
            subtitle: "Exatamente Três Passos",
            narrative: "O Leão adversário possui apenas uma saída aberta. Calcule a rota exata de 3 passos da sua Zebra contornando o território para aplicar a vitória.",
            tip: "A Zebra precisa dar exatamente 3 passos ao longo da borda: 1, 2, 3 até a casa destacada. A colmeia nunca pode se dividir!",
            botDifficulty: .didactic,
            botDifficultyName: "Didático",
            targetParTurns: 1,
            isPuzzleScenario: true,
        ...
        CampaignLevel(
            ...
            subtitle: "Canguru em Linha Reta",
            narrative: "O Leão inimigo se escondeu atrás de uma fileira densa de peças. Use o Canguru para saltar sobre a muralha inteira e cravar o ponto decisivo.",
            tip: "Cangurus saltam em linha reta sobre as peças até a primeira casa vaga do outro lado.",
            botDifficulty: .didactic,
            botDifficultyName: "Didático",
            targetParTurns: 1,
            isPuzzleScenario: true,
        ...
        CampaignLevel(
            id: 4,
            chapterNumber: 4,
            title: "A Força do Gorila",
            subtitle: "Avanço e Cerco Implacável",
            narrative: "O Leão adversário está encurralado em 5 lados, restando apenas um espaço. Avance com seu Gorila para ocupar a última casa aberta e garantir a vitória imediata!",
            tip: "Mova o Gorila 1 passo para a casa vazia ao lado do Leão adversário ou suba em uma peça para dominar o espaço.",
            botDifficulty: .didactic,
            botDifficultyName: "Didático",
            targetParTurns: 1,
            isPuzzleScenario: true,
        ...
        CampaignLevel(
            ...
            narrative: "O Leão adversário está protegido em um bolsão estreito inacessível pelo chão. Voe com a Águia por cima e desça direto no bolsão de vitória.",
            tip: "A Águia sobrevoa duas peças no topo da formação e desce no terceiro passo em uma casa vazia.",
            botDifficulty: .didactic,
            botDifficultyName: "Didático",
            targetParTurns: 1,
            isPuzzleScenario: true,
        ...
        CampaignLevel(
            id: 6,
            chapterNumber: 6,
            title: "A Grande Batalha de Huli",
            subtitle: "Partida Real com Dicas do Mestre",
            narrative: "Você dominou as principais táticas de Huli! Agora comande seu bando completo em uma partida real. Use o botão de Dica sempre que quiser sugestões estratégicas.",
